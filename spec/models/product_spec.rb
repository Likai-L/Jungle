...
RSpec.describe Product, type: :model do
  describe 'Validations' do
    it 'have no validation error when creating a new product without all fields filled' do
      @category = Category.create(name: 'evergreens')
      @product = Product.create(name: 'some_plant', price: 998, quantity: 1, category: @category)
